...
# Add design files
add_files sha3.c -cflags [concat -include $slxpluginhome/include/slxplugin.h]
# Add test bench & files
add_files -tb main.c

# Set the top-level function
set_top sha3_keccakf

# ########################################################
# Try without any specific control
...
# ########################################################
# Try with only loop-interchange prep passes
request_solution 1.nointerchange 333MHz "LLVM_CUSTOM_CMD -slx-prepare-interchange, no Xilinx directives"
run_the_design "-slx-prepare-for-interchange -slx-prepare-all"
exit
